        ...
        <div className='footer'>
            ...
            <div className="footer-group">
                ...
                <ul className='footer-ul footer-nav'>                    
                    <li>
                        <Link onClick={()=>{window.scrollTo(0,0)}} to='/Contact-Us' className='footer-text' href="">Contact Us</Link>
                    </li>
                    <li>
                        <Link onClick={()=>{window.scrollTo(0,0)}} to='/Stores' className='footer-text' href="">Stores</Link>
                    </li>
                    <li>
                        <Link onClick={()=>{window.scrollTo(0,0)}} to='/Q&A' className='footer-text' href="">Question and Answers</Link>
                    </li>
                    <li>
                        <Link onClick={()=>{window.scrollTo(0,0)}} to='/TermsOfService' className='footer-text' href="">Terms Of Service</Link>
                    </li>
                    <li>
                        <Link onClick={()=>{window.scrollTo(0,0)}} to='/RefundPolicy' className='footer-text' href="">Refund Policy</Link>
                    </li>                    
                </ul>
            </div>
            <div className="footer-group">
